...
<li><a class="dropdown-item" href="../views/listaTudoUsuariosCod.php">Buscar por código</a></li>
</ul>
</li>
<li class="nav-item dropdown">
<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"role="button" data-bs-toggle="dropdown"aria-expanded="false">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="../views/cadastroclientes.php">cadastro</a></li>
            <li><a class="dropdown-item" href="../views/listaTudoClientes.php">Visualizar</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="../views/listaTudoClientesCod.php">Busca por código</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="../views/listaTudoFuncionariosCod.php">Busca por código</a></li>
            <li><a class="dropdown-item" href="../views/listaTudoFuncionariosNome.php">Busca por nome</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="../views/cadastropedidos.php">cadastro</a></li>
